...
const MODULES=[
 ...
 {groupCode:'foundation',groupName:'Grundlösning',selectionMode:'multi',code:'pier',name:'Plintgrund',description:'Grundläggning på plintar.'},
 {groupCode:'foundation',groupName:'Grundlösning',selectionMode:'multi',code:'basement',name:'Källare / suterrängdel',description:'Husdel med källarväggar och djupare schakt.'},
 {groupCode:'frame',groupName:'Stomtyp',selectionMode:'single',code:'timber_frame',name:'Träregelstomme',description:'Platsbyggd träregelstomme.'},
 {groupCode:'frame',groupName:'Stomtyp',selectionMode:'single',code:'log',name:'Timmerstomme',description:'Bärande timmerstomme.'},
 {groupCode:'frame',groupName:'Stomtyp',selectionMode:'single',code:'prefab',name:'Prefabricerade väggelement',description:'Prefabricerade bärande väggelement.'},
 {groupCode:'frame',groupName:'Stomtyp',selectionMode:'single',code:'masonry',name:'Murad stomme',description:'Murad bärande stomme.'},
 {groupCode:'roof',groupName:'Takstomme',selectionMode:'single',code:'truss',name:'Takstolar',description:'Takstolskonstruktion.'},
 {groupCode:'roof',groupName:'Takstomme',selectionMode:'single',code:'purlin',name:'Åstak',description:'Tak med bärande åsar/sparrar.'},
 {groupCode:'sewage',groupName:'Avlopp',selectionMode:'single',code:'municipal_sewage',name:'Kommunalt avlopp',description:'Anslutning till kommunalt spillvatten.'},
 {groupCode:'sewage',groupName:'Avlopp',selectionMode:'single',code:'private_sewage',name:'Enskilt avlopp',description:'Egen avloppsanläggning eller anslutning till gemensam enskild anläggning.'},
 {groupCode:'water',groupName:'Vatten',selectionMode:'single',code:'municipal_water',name:'Kommunalt vatten',description:'Kommunal vattenanslutning.'},
 {groupCode:'water',groupName:'Vatten',selectionMode:'single',code:'shared_water',name:'Gemensamt vatten',description:'Vatten via samfällighet/gemensamhetsanläggning.'},
 {groupCode:'water',groupName:'Vatten',selectionMode:'single',code:'private_well',name:'Egen brunn',description:'Egen vattenbrunn.'},
 {groupCode:'ventilation',groupName:'Ventilation',selectionMode:'single',code:'natural_vent',name:'Självdrag',description:'Ventilation huvudsakligen med självdrag.'},
 {groupCode:'ventilation',groupName:'Ventilation',selectionMode:'single',code:'extract_vent',name:'Mekanisk frånluft',description:'Mekanisk frånluftsventilation.'},
 {groupCode:'ventilation',groupName:'Ventilation',selectionMode:'single',code:'ftx',name:'FTX',description:'Balanserad ventilation med värmeåtervinning.'},
...
const BASE:W[]=[
 ...
 {number:'30',name:'Bärande stomme',sections:[{number:'30.10',name:'Stomme',tasks:[{title:'Res bärande stomme',activities:[{title:'Kontrollera grund och stomstart',type:'check'},{title:'Res vald bärande stomme',type:'perform'},{title:'Kontrollera färdig stomme mot konstruktionshandlingar',type:'check'},{title:'Dokumentera kritiska dolda förband där det behövs',type:'document'}]}]}]},
 {number:'40',name:'Tak',sections:[{number:'40.10',name:'Takstomme',tasks:[{title:'Bygg bärande tak',activities:[{title:'Kontrollera upplag och takgeometri',type:'check'},{title:'Montera vald bärande takkonstruktion',type:'perform'},{title:'Kontrollera förankring, stabilitet och genomföringar',type:'check'}]}]},{number:'40.20',name:'Yttertak',tasks:[{title:'Färdigställ yttertak',activities:[{title:'Utför undertak och underlagstäckning enligt system',type:'perform'},{title:'Montera taktäckning, beslag och tätningar',type:'perform'},{title:'Montera erforderlig taksäkerhet',type:'perform'},{title:'Kontrollera färdigt tak och genomföringar',type:'check'}]}]}]},
 {number:'50',name:'Klimatskal',sections:[{number:'50.10',name:'Fönster och dörrar',tasks:[{title:'Montera fönster och ytterdörrar',activities:[{title:'Kontrollera öppningsmått',type:'check'},{title:'Montera och täta fönster och ytterdörrar',type:'perform'},{title:'Kontrollera infästning, funktion och tätning',type:'check'}]}]},{number:'50.20',name:'Isolering och tätning',tasks:[{title:'Färdigställ klimatskal',activities:[{title:'Montera föreskriven isolering och luft-/ångtätning',type:'perform'},{title:'Kontrollera kritiska anslutningar och genomföringar',type:'check'},{title:'Dokumentera dolda klimatskalsdetaljer vid behov',type:'document'}]}]}]},
 {number:'60',name:'Installationer',sections:[{number:'60.10',name:'VVS',tasks:[{title:'Utför VVS-installation',activities:[{title:'Samordna rörvägar och genomföringar',type:'check'},{title:'Montera vatten- och spillvatteninstallationer',type:'perform'},{title:'Kontrollera fall, infästningar och dolda installationer',type:'check'},{title:'Utför föreskriven täthets- eller provtryckningskontroll',type:'measurement'}]}]},{number:'60.20',name:'El',tasks:[{title:'Utför elinstallation',activities:[{title:'Kontrollera att elarbeten utförs av registrerat elinstallationsföretag',type:'check'},{title:'Samordna och utför elinstallation',type:'perform'},{title:'Kontrollera dold installation före igenbyggnad',type:'check'},{title:'Samla elintyg och provningsunderlag',type:'document'}]}]},{number:'60.30',name:'Ventilation',tasks:[{title:'Utför ventilation',activities:[{title:'Montera vald ventilationslösning',type:'perform'},{title:'Funktionskontrollera ventilation',type:'measurement'},{title:'Samla erforderligt ventilationsunderlag',type:'document'}]}]}]},
...
const EXTRA:T[]=[
 ...
 {module:'pier',title:'Utför plintgrund',activities:[{title:'Placera och utför plintar enligt konstruktionshandling',type:'perform'},{title:'Kontrollera läge, höjd och bärande upplag',type:'measurement'}]},
 {module:'basement',title:'Utför källar-/suterrängdel',activities:[{title:'Schakta för källar-/suterrängdel',type:'perform'},{title:'Utför källarväggar och golvkonstruktion',type:'perform'},{title:'Utför utvändigt fuktskydd och dränering',type:'perform'},{title:'Kontrollera före återfyllning',type:'check'}]},
 {module:'timber_frame',title:'Utför träregelstomme',activities:[{title:'Res träregelstomme enligt konstruktionshandling',type:'perform'},{title:'Kontrollera avväxlingar, förankring och stabilisering',type:'check'}]},
 {module:'prefab',title:'Montera prefabricerad stomme',activities:[{title:'Montera väggelement enligt montageplan',type:'perform'},{title:'Kontrollera förankring, skarvar och stabilisering',type:'check'}]},
 {module:'masonry',title:'Utför murad stomme',activities:[{title:'Mura bärande väggar enligt handling',type:'perform'},{title:'Kontrollera armering, förankring och öppningar',type:'check'}]},
